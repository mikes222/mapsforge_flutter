...
class Blob extends $pb.GeneratedMessage {
  factory Blob({
    ...
    @$core.Deprecated('This field is deprecated.') $core.List<$core.int>? oBSOLETEBzip2Data,
  }) {
    final $result = create();
    if (raw != null) {
      $result.raw = raw;
  ...
  static final $pb.BuilderInfo _i =
      $pb.BuilderInfo(_omitMessageNames ? '' : 'Blob', package: const $pb.PackageName(_omitMessageNames ? '' : 'OSMPBF'), createEmptyInstance: create)
...
class BlobHeader extends $pb.GeneratedMessage {
  ...
  static final $pb.BuilderInfo _i =
      $pb.BuilderInfo(_omitMessageNames ? '' : 'BlobHeader', package: const $pb.PackageName(_omitMessageNames ? '' : 'OSMPBF'), createEmptyInstance: create)
