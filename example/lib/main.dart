...
final List<MapFileData> MAP_FILE_DATA_LIST = [
  ...
  const MapFileData(
    ...
    url: "https://tuc.cloud/index.php/s/3SWmkSt7eZafqgM/download/indoorUB_Stand_22_09_23.map",
    fileName: "indoorUB_Stand_22_09_23.map",
    displayedName: "Chemnitz - Library (Indoor) - custom",
    theme: "assets/render_themes/custom.xml",
  ...
  const MapFileData(
    ...
    theme: "assets/render_themes/custom_cud_high_contrast.xml",
    initialPositionLat: 50.84160,
    initialPositionLong: 12.92700,
    initialZoomLevel: 18,
    indoorZoomOverlay: true,
  ...
  const MapFileData(
    url: "https://tuc.cloud/index.php/s/L6WYFd6zaCe8sky/download/indoorUStation.map",
    fileName: "indoorUStation.map",
    displayedName: "Chemnitz - U-Station (Indoor)",
    initialPositionLat: 50.8158,
    initialPositionLong: 12.9316,
    initialZoomLevel: 19,
    indoorZoomOverlay: true,
    indoorLevels: {0: 'EG', -1: 'UG1'},
  ),
  const MapFileData(
