...
void main() {
  ...
  //   BoundingBox boundingBox = const BoundingBox(47.777222, 16.193332, 47.908852, 16.326537);
  //   //int zoomLevel = PixelProjection.calculateFittingZoomlevel(boundingBox, Size(500, 800));
  //   //expect(zoomLevel, 12);
  // });
}
