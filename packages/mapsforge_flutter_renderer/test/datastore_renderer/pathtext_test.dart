  ...
  testWidgets('Should draw pathtext from left-bottom to right-top', (WidgetTester tester) async {
    ...
    var img = await (tester.runAsync(() async {
      ...
      datastore.addWay(
        Way(
          0,
          [const Tag('highway', 'motorway'), const Tag('ref', 'A234')],
          [
            [const LatLong(45.998, 17.996), const LatLong(46.0006, 18.0006)],
          ],
          null,
        ),
      );
  ...
  testWidgets('Should draw pathtext from right-top to left-bottom ', (WidgetTester tester) async {
    ...
    var img = await (tester.runAsync(() async {
      ...
      datastore.addWay(
        Way(
          0,
          [const Tag('highway', 'motorway'), const Tag('ref', 'A246589')],
          [
            [const LatLong(46.0006, 18.0006), const LatLong(45.998, 17.996)],
          ],
          null,
        ),
      );
  ...
  testWidgets('Should draw pathtext AND linesymbol from right-top to left-bottom ', (WidgetTester tester) async {
    ...
    var img = await (tester.runAsync(() async {
      ...
      datastore.addWay(
        Way(
          0,
          [const Tag('highway', 'motorway'), const Tag('ref', 'A246589'), const Tag('oneway', 'yes')],
          [
            [const LatLong(46.0006, 18.0006), const LatLong(45.998, 17.996)],
          ],
          null,
