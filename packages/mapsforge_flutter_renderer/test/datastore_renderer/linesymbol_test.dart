  ...
  testWidgets('Should draw linesymbol from left-bottom to right-top', (WidgetTester tester) async {
    ...
    var img = await (tester.runAsync(() async {
      ...
      datastore.addWay(
        Way(
          0,
          [const Tag('highway', 'motorway'), const Tag('oneway', 'yes')],
          [
    ...
    var img = await (tester.runAsync(() async {
      ...
      datastore.addWay(
        Way(
          ...
          [const Tag('highway', 'motorway'), const Tag('oneway', 'yes')],
          [
            [const LatLong(46.0004, 18.0006), const LatLong(45.95, 17.953)],
          ],
          null,
        ),
      );
    ...
    var img = await (tester.runAsync(() async {
      ...
      datastore.addWay(
        Way(
          ...
          [const Tag('highway', 'motorway'), const Tag('oneway', 'yes')],
          [
            [const LatLong(45.95, 18.002), const LatLong(46.0004, 18.0006), const LatLong(45.95, 17.953)],
          ],
          null,
        ),
      );
