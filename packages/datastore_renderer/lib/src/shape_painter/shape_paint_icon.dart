...
class ShapePaintIcon extends UiShapePainter<RenderinstructionIcon> {
  ...
  ShapePaintIcon._(RenderinstructionIcon renderinstruction) : super(renderinstruction) {
    fill = UiPaint.fill(color: renderinstruction.getBitmapColor());
  }

  static Future<ShapePaintIcon> create(RenderinstructionIcon renderinstruction) async {
    return _taskQueue.add(() async {
      if (renderinstruction.shapePainter != null) return renderinstruction.shapePainter! as ShapePaintIcon;
      ShapePaintIcon shapePaint = ShapePaintIcon._(renderinstruction);
