...
class LineString {
  ...
  LineString extractPart(double startDistance, double endDistance) {
    ...
    for (int i = 0; i < this.segments.length; startDistance -= this.segments.elementAt(i).length(), endDistance -= this.segments.elementAt(i).length(), i++) {
  ...
  @override
  bool operator ==(Object other) => identical(this, other) || other is LineString && runtimeType == other.runtimeType && segments == other.segments;
