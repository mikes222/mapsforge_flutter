...
class PlatformReadbufferExample {
  ...
  static Future<void> readNativeFile(String filePath) async {
    final source = createReadbufferSource(filePath);
  ...
  static Future<void> readWebFile(html.File file) async {
    final source = createReadbufferSource("", file);
  ...
  static Future<void> readRemoteFile(String url) async {
    final source = createReadbufferSource(url);
  ...
  static Future<ReadbufferSource?> createSource({String? filePath, html.File? file, String? url}) async {
    ...
    if (filePath != null) {
      return createReadbufferSource(filePath);
    }

    // Try web file object
    if (file != null) {
      return createReadbufferSource("", file);
    }

    // Try remote URL
    if (url != null) {
      return createReadbufferSource(url);
    }
