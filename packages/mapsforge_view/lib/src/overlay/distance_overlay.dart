...
class DistanceOverlay extends StatefulWidget {
  ...
  DistanceOverlay({required this.mapModel});
      ...
      child: FadeTransition(
        ...
        child: StreamBuilder(
          ...
          builder: (BuildContext context, AsyncSnapshot<MapPosition> snapshot) {
            ...
            if (_timer == null && (_lastDisplayed == null || _lastDisplayed! < DateTime.now().millisecondsSinceEpoch - 30 * 1000)) {
            ...
            return Column(
              ...
              children: [
                CustomPaint(
                  size: Size(_pixel, 8),
                  foregroundPainter: MeterPainter(pixel: _pixel, color: Theme.of(context).textTheme.bodyMedium?.color ?? Colors.black),
                ),
