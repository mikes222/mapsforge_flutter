  ...
  group('AreaMarker shouldPaint optimization', () {
    ...
    setUp(() {
      ...
      List<ILatLong> smallPath = [
        const LatLong(52.5200, 13.4050), // Berlin center
        const LatLong(52.5201, 13.4050),
        const LatLong(52.5201, 13.4051),
        const LatLong(52.5200, 13.4051),
      ];
    ...
    test('should paint larger intersections at high zoom levels', () async {
      ...
      BoundingBox largeBoundary = const BoundingBox(52.5199, 13.4049, 52.5202, 13.4052);
    ...
    test('should respect zoom level range', () async {
      ...
      AreaMarker<String> limitedMarker = AreaMarker<String>(
        path: [const LatLong(52.5200, 13.4050), const LatLong(52.5201, 13.4051), const LatLong(52.5200, 13.4051)],
        zoomlevelRange: const ZoomlevelRange(5, 12),
      );
    ...
    test('should handle non-intersecting boundaries', () async {
      ...
      BoundingBox nonIntersectingBoundary = const BoundingBox(52.510, 13.390, 52.515, 13.395);
