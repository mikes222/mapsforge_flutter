  ...
  group('Mapfile Converter', () {
    ...
    test('should convert pbf file to map format', () async {
      ...
      try {
        ...
        // Verify the output file was created and has content
        expect(await outputFile.exists(), isTrue, reason: 'Output file should exist');
        expect(await outputFile.length(), greaterThan(200000), reason: 'Output file should not be empty');
        expect(await outputFile.length(), lessThan(220000), reason: 'Output file should not be empty');
