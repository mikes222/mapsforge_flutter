...
void main() async {
  ...
  testWidgets("Test monaco casino south part cropping for a tile", (WidgetTester tester) async {
    ...
    await expectLater(find.byType(RawImage), matchesGoldenFile('goldens/way_cropper_casino.png'));
  });
  ...
  testWidgets("Test monaco casino east part cropping for a tile", (WidgetTester tester) async {
    ...
    await tester.pumpAndSettle();
    await expectLater(find.byType(RawImage), matchesGoldenFile('goldens/way_cropper_casino2.png'));
  });
  ...
  testWidgets("Test admin_level2 cropping for a tile", (WidgetTester tester) async {
    ...
    await tester.pumpAndSettle();
    await expectLater(find.byType(RawImage), matchesGoldenFile('goldens/way_cropper_adminlevel.png'));
  });
  ...
  testWidgets("Test admin_level2 cropping for a tile one tile above", (WidgetTester tester) async {
    ...
    await tester.pumpAndSettle();
    await expectLater(find.byType(RawImage), matchesGoldenFile('goldens/way_cropper_adminlevel2.png'));
  });
}
