...
void main() {
  test('split-test1', () {
    ...
    MatchingCacheKey m1 = MatchingCacheKey(tagList1, 5, Closed.YES);
    MatchingCacheKey m2 = MatchingCacheKey(tagList1, 5, Closed.YES);
    MatchingCacheKey m3 = MatchingCacheKey([tag1], 5, Closed.YES);
    MatchingCacheKey m4 = MatchingCacheKey([Tag('', '')], 5, Closed.YES);
    MatchingCacheKey m5 = MatchingCacheKey([Tag('test', '')], 5, Closed.YES);
