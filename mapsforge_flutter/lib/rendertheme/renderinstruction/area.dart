...
class Area extends RenderInstruction {
  ...
  String src;
  Paint stroke;
  Map<int, Paint> strokes;
  double strokeWidth;

  Area(graphicFactory, displayModel, String elementName, this.level,
...
//        this.fill.setColorFromNumber(XmlUtils.getColor(
//            graphicFactory, value, displayModel.getThemeCallback(), this));
      } else if (RenderInstruction.SCALE == name) {
        this.scale = scaleFromValue(value);
      } else if (RenderInstruction.STROKE == name) {
//        this.stroke.setColorFromNumber(XmlUtils.getColor(
//            graphicFactory, value, displayModel.getThemeCallback(), this));
...
// no-op
  ...
  Paint getStrokePaint(int zoomLevel) {
