...
import 'package:mapsforge_flutter/rendertheme/xml/xmlrenderthemestylemenu.dart';
...
class RenderThemeHandler {
  ...
  RenderThemeHandler(this.graphicFactory, this.displayModel,
      this.relativePathPrefix, this.xmlRenderTheme);
