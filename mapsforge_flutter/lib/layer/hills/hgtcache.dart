...
import 'package:dfb/mapsforge/graphics/canvas.dart';
import 'package:dfb/mapsforge/graphics/graphicfactory.dart';
import 'package:dfb/mapsforge/graphics/hillshadingbitmap.dart';
import 'package:dfb/mapsforge/graphics/hillshadingbitmap.dart';
import 'package:dfb/mapsforge/graphics/hillshadingbitmap.dart';
import 'package:dfb/mapsforge/layer/hills/shadingalgorithm.dart';
import 'package:dfb/mapsforge/model/boundingbox.dart';
...
class HgtCache {
  ...
  HgtCache(this.demFolder, this.interpolationOverlap,
      this.graphicsFactory, this.algorithm,
...
//                                hgtFiles.put(tileKey, new HgtFileInfo(file, east, north, east+1, north-1));
  ...
  HillshadingBitmap getHillshadingBitmap(int northInt, int eastInt,
      double pxPerLat, double pxPerLng) {
...
class HgtFileInfo extends BoundingBox
  ...
  HgtFileInfo(File file, double minLatitude, double minLongitude,
